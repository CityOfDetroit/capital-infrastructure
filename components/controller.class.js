...
export default class Controller {
  constructor(container) {
    ...
    this.map = new Map({
      ...
      sources: [
        {
          id: "dpw-residential-resurfacing",
          type: "vector",
          url: "mapbox://cityofdetroit.ad8e3igc"
        },
        {
          id: "dpw-c-resurfacing",
          type: "vector",
          url: "mapbox://cityofdetroit.4hfddld6"
        },
        {
          id: "dpw-major-resurfacing",
          type: "vector",
          url: "mapbox://cityofdetroit.3ih23j4m"
        },
        {
          id: "streetscape",
          type: "vector",
          url: "mapbox://cityofdetroit.3vs8qtec"
        },
        {
          id: "single-point",
          type: "geojson",
      ...
      layers: [
        ...
        // },
        {
          "id": "dpw-residential-resurfacing",
          "type": "line",
          "source": "dpw-residential-resurfacing",
          "source-layer": "residential_roads_20190331-7qg4pb",
          "layout": {},
          "paint": {
            "line-color": "#004544",
            "line-width": 4
        ...
        {
          "id": "dpw-residential-resurfacing-hover",
          "type": "line",
          "source": "dpw-residential-resurfacing",
          "source-layer": "residential_roads_20190331-7qg4pb",
          "layout": {},
        ...
        {
          "id": "dpw-residential-resurfacing-featured",
          "type": "line",
          "source": "dpw-residential-resurfacing",
          "source-layer": "residential_roads_20190331-7qg4pb",
          "layout": {},
        ...
        },
        {
          "id": "dpw-c-resurfacing",
          "type": "line",
          "source": "dpw-c-resurfacing",
          "source-layer": "2019_Class_C_Resurfacing_Cand-c1cm40",
          "layout": {},
          "paint": {
            "line-color": "#004544",
            "line-width": 4
        ...
        },
        {
          "id": "dpw-major-resurfacing",
          "type": "line",
          "source": "dpw-major-resurfacing",
          "source-layer": "Major_Roads_Projects20190327-bmw4uo",
          "layout": {},
          "paint": {
            "line-color": "#004544",
            "line-width": 4
        ...
        {
          "id": "dpw-major-resurfacing-hover",
          "type": "line",
          "source": "dpw-major-resurfacing",
          "source-layer": "Major_Roads_Projects20190327-bmw4uo",
          "layout": {},
        ...
        },
        {
          ...
          "type": "line",
          "source": "streetscape",
          "source-layer": "Streetscape_Projects-8wijgg",
          "layout": {},
          "paint": {
            "line-color": "#E48F22",
            "line-width": 4
